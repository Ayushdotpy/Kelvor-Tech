...
const Hero = () => {
  ...
  return (
    ...
    <header className="relative min-h-screen flex items-center justify-center pt-32 pb-16 overflow-hidden">
      {/* Massive Parallax Backdrop text */}
      <div className="absolute inset-0 flex items-center justify-center select-none pointer-events-none z-0">
        <span
          ref={parallaxTextRef}
          className="font-display text-[150px] lg:text-[280px] font-extrabold text-primary/[0.03] tracking-tight transition-transform duration-100 ease-out inline-block"
      ...
      <div className="container mx-auto px-6 lg:px-12 flex flex-col items-center relative z-10 max-w-7xl">
        ...
        <div className="glass-panel floating-cta max-w-4xl p-8 md:p-12 rounded-container-radius shadow-2xl text-center md:-mt-32 relative z-20 w-full border border-secondary/10">
          ...
          <h1 className="font-display text-4xl md:text-6xl font-black text-primary mb-6 tracking-tight leading-none">
            Building Technology That Powers Modern Businesses.
          </h1>
          <p className="font-sans text-base md:text-lg text-secondary mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          {/* Metrics Counter row */}
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6 border-t border-secondary/15 pt-8">
